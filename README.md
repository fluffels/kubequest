...
| 4 | GitOps (Argo CD), App-of-Apps, Pull-Prinzip | 🟡 angefangen: Insel „GitOps-Archipel“ ist begehbar (Anleger/Warp per Steg), Argo-CD-Sim & Insel-NPC (Steuerfrau Argos) sind da; die Lern-Quests folgen |
