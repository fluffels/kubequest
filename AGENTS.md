...
- **Grenze:** Issue-Management ist die einzige nach außen wirkende Aktion, die freigegeben ist — **committen/pushen/deployen bleibt auch hier tabu** (siehe harte Regeln oben, macht fluffels selbst). Da Code uncommitted bleibt: Issues ruhig als erledigt schließen, wenn die Arbeit im Working Tree fertig + getestet ist; falls ihr Review noch was findet, einfach wieder aufmachen.
