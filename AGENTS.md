...
Beim Weitermachen: offene Issues nach Priorität abarbeiten, nach jedem Punkt `npm test` grün halten + im Browser verifizieren, dann das Issue schließen (Katharina selbst, beim Commit per `Closes #<n>`).
