...
| # | Titel | Prio |
|---|---|---|
| [#57](https://github.com/eckekat/kubequest/issues/57) | Tiled-basierte Tilemaps + Map-/Warp-Registry statt handgebauter Karte | 🔴 hoch |
| [#58](https://github.com/eckekat/kubequest/issues/58) | Build-Strategie entkoppeln: Prod-Build (Lazy-Loading) vs. Single-File-Offline-Export | 🟠 mittel |
| [#59](https://github.com/eckekat/kubequest/issues/59) | Asset-Pipeline: Manifest-getriebenes Laden statt manueller `assets-data.ts` + Frame-Slicing | 🟠 mittel |
| [#60](https://github.com/eckekat/kubequest/issues/60) | Content-Typsicherheit: diskriminierte Union für `QuestStep` | 🟠 mittel |
| [#61](https://github.com/eckekat/kubequest/issues/61) | Spielstand beim Laden validieren/sanitisieren (defensives Schema) | 🟡 niedrig |
