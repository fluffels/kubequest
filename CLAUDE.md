...
| [`src/content/data/`](src/content/data/) | Daten | Content-as-Data-Quelle (#348): `npcs.json`, `smalltalk.json`, `quests.json` – der eigentliche Spielinhalt als JSON (vom Loader geladen + validiert, von Vite gebündelt; kein Runtime-`fetch`, Offline-Build bleibt heil) |
