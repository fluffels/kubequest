...
import { expandRect, cull, FrameSampler, type Cullable } from "./cull";
  ...
  class ArchipelScene extends Phaser.Scene {
    ...
    create() {
      ...
      // GitOps-NPC „Argos" (#93): die Steuerfrau des Archipels, die ab #94 die
      ...
      // später Quests) greifen über nearestNpc() auf Argos. enterArchipel() hatte
    ...
    update(_time: number, delta: number) {
      ...
      // Quest-Marker über Argos (zeigt „!", sobald ab #94 ein Quest-Dialogschritt ansteht).
      ...
      // schläft, solange die Insel läuft – ohne diesen Aufruf bliebe Argos ohne
